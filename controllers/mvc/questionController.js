...
exports.deleteQuestion = async (req, res) => {
  try {
    ...
    // Redirect về trang hiện tại và gửi thông báo
    req.flash("success", "Question deleted successfully"); // Nếu bạn sử dụng connect-flash
    res.render('questions/showQuestion'); // Quay lại trang trước đó
  } catch (error) {
    console.error(error);
    res.status(500).send("Internal Server Error");
  }
